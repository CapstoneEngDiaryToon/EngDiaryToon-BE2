...
import com.example.leeseokjin.authentication.oauth2.*;
import com.example.leeseokjin.authentication.oauth2.account.OAuth2AccountDTO;
import com.example.leeseokjin.authentication.oauth2.service.OAuth2Service;
import com.example.leeseokjin.authentication.oauth2.service.OAuth2ServiceFactory;
import com.example.leeseokjin.authentication.oauth2.userInfo.OAuth2UserInfo;
...
import com.example.leeseokjin.users.UserService;
...
public class AuthenticationController {
    ...
    public void oAuth2AuthenticationCallback(@PathVariable String provider, OAuth2AuthorizationResponse oAuth2AuthorizationResponse, HttpServletRequest request, HttpServletResponse response, @AuthenticationPrincipal UserDetailsImpl loginUser) throws Exception {
        ...
        // 로그 추가 - provider 값과 oAuth2AuthorizationResponse 상태 확인
        log.info("OAuth2 Callback initiated.");
        log.info("Provider: {}", provider);
        log.info("OAuth2AuthorizationResponse - State: {}", oAuth2AuthorizationResponse.getState());
        log.info("OAuth2AuthorizationResponse - Code: {}", oAuth2AuthorizationResponse.getCode());
        log.info("OAuth2AuthorizationResponse - Error: {}", oAuth2AuthorizationResponse.getError());
        ...
        if (oAuth2AuthorizationResponse.getError() != null) {
            log.error("OAuth2 Authorization Error: {}", oAuth2AuthorizationResponse.getError());
        ...
        //계정 연동에 대한 콜백 처리
            ...
            try {
                ...
                log.error("Account link error: {}", e.getMessage());
